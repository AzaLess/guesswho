...
const translations: Translations = {
  en: {
    ...
    'rules.author': '📝 Fact author gets points = number of wrong attempts',
    'rules.winner': '🥇 Winner: Player with the most points',
    'rules.backToMenu': '🏠 Back to Menu',
    
    // Example facts
    'rules.examples': '💡 Examples of interesting facts',
    'rules.example1': 'I can wiggle my ears while whistling at the same time',
    'rules.example2': 'I accidentally called a celebrity once',
    'rules.example3': 'I collect rocks that look like animals',
    'rules.example4': 'I can recite the alphabet backwards in under 10 seconds',
    'rules.example5': 'I am afraid of butterflies but love spiders',
    'rules.example6': 'I can perfectly imitate 7 different accents',
    'rules.example7': 'I once ate only green food for 3 days straight',
    'rules.example8': 'I can identify any coin by touch with my eyes closed',
    'rules.example9': 'I talk in my sleep, but only in French',
    'rules.example10': 'I have photographic memory for phone numbers',
  ...
  uk: {
    ...
    'rules.correct': '✅ Правильна відповідь: +3 бали',
    'rules.author': '📝 Автор факту отримує бали = кількість неправильних спроб',
    'rules.winner': '🥇 Переможець: Гравець з найбільшою кількістю балів',
    'rules.backToMenu': '🏠 Повернутися в меню',
    
    // Example facts
    'rules.examples': '💡 Приклади цікавих фактів',
    'rules.example1': 'Я можу ворушити вухами під час свисту одночасно',
    'rules.example2': 'Я випадково подзвонив знаменитості',
    'rules.example3': 'Я збираю камінці, які схожі на тварин',
    'rules.example4': 'Я можу промовити алфавіт навпаки менш ніж за 10 секунд',
    'rules.example5': 'Я боюся метеликів, але люблю павуків',
    'rules.example6': 'Я можу ідеально імітувати 7 різних акцентів',
    'rules.example7': 'Я колись їв тільки зелену їжу 3 дні поспіль',
    'rules.example8': 'Я можу визначити будь-яку монету на дотик із закритими очима',
    'rules.example9': 'Я розмовляю уві сні, але тільки французькою',
    'rules.example10': 'У мене фотографічна пам\'ять на номери телефонів',
  ...
  ru: {
    ...
    'rules.author': '📝 Автор факта получает очки = количество неправильных попыток',
    'rules.winner': '🥇 Победитель: Игрок с наибольшим количеством очков',
    'rules.backToMenu': '🏠 Вернуться в меню',
    
    // Example facts
    'rules.examples': '💡 Примеры интересных фактов',
    'rules.example1': 'Я могу шевелить ушами во время свиста одновременно',
    'rules.example2': 'Я случайно позвонил знаменитости',
    'rules.example3': 'Я собираю камни, которые выглядят как животные',
    'rules.example4': 'Я могу произносить алфавит в обратном порядке менее чем за 10 секунд',
    'rules.example5': 'Я боюсь бабочек, но люблю пауков',
    'rules.example6': 'Я могу идеально имитировать 7 разных акцентов',
    'rules.example7': 'Я однажды ел только зеленую еду в течение 3 дней подряд',
    'rules.example8': 'Я могу идентифицировать любую монету по прикосновению с закрытыми глазами',
    'rules.example9': 'Я разговариваю во сне, но только по-французски',
    'rules.example10': 'Я имею фотографическую память для номеров телефонов',
